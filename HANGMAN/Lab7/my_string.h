...
//      and included) will be added to the string until a stopping condition//       is met.  The capacity of the string will continue to grow as needed
...
//   left as NULL and any memory that may have been used bya potential
...
Bool my_string_contains(MY_STRING hMy_string, char letter);
